...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEPARACION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SEPARACION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SEPARACION actions', async () => {
      const arg = { id: 10705 };
    ...
    it('dispatches UPDATE_SEPARACION actions', async () => {
      const arg = { id: 10705 };
    ...
    it('dispatches PARTIAL_UPDATE_SEPARACION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SEPARACION actions', async () => {
      const arg = 42666;
