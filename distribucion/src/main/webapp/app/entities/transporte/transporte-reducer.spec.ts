...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSPORTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRANSPORTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRANSPORTE actions', async () => {
      const arg = { id: 14901 };
    ...
    it('dispatches UPDATE_TRANSPORTE actions', async () => {
      const arg = { id: 14901 };
    ...
    it('dispatches PARTIAL_UPDATE_TRANSPORTE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRANSPORTE actions', async () => {
      const arg = 42666;
