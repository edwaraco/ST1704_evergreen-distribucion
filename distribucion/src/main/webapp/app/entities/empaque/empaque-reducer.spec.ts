...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './empaque.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPAQUE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EMPAQUE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EMPAQUE actions', async () => {
      const arg = { id: 1791 };
    ...
    it('dispatches UPDATE_EMPAQUE actions', async () => {
      const arg = { id: 1791 };
    ...
    it('dispatches PARTIAL_UPDATE_EMPAQUE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EMPAQUE actions', async () => {
      const arg = 42666;
