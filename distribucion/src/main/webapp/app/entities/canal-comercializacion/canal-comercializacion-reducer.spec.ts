...
import reducer, {
  ...
  reset,
  updateEntity,
} from './canal-comercializacion.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANALCOMERCIALIZACION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CANALCOMERCIALIZACION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CANALCOMERCIALIZACION actions', async () => {
      const arg = { id: 7569 };
    ...
    it('dispatches UPDATE_CANALCOMERCIALIZACION actions', async () => {
      const arg = { id: 7569 };
    ...
    it('dispatches PARTIAL_UPDATE_CANALCOMERCIALIZACION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CANALCOMERCIALIZACION actions', async () => {
      const arg = 42666;
