package com.evergreen.distribucion.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.evergreen.distribucion.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.evergreen.distribucion.repository.UserRepository.USERS_BY_EMAIL_CACHE);
