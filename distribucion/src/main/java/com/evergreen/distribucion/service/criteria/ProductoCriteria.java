...
public class ProductoCriteria implements Serializable, Criteria {
    ...
    public ProductoCriteria(ProductoCriteria other) {
        ...
        this.pedidoId = other.optionalPedidoId().map(LongFilter::copy).orElse(null);
    ...
    public Optional<LongFilter> optionalPedidoId() {
        return Optional.ofNullable(pedidoId);
    }

    public LongFilter pedidoId() {
        if (pedidoId == null) {
            setPedidoId(new LongFilter());
        }
        return pedidoId;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, identificador, nombre, descripcion, fechaElaboracion, lote, cantidad, unidadMedida, pedidoId, distinct);
    }
    ...
    public String toString() {
        return "ProductoCriteria{" +
            ...
            optionalPedidoId().map(f -> "pedidoId=" + f + ", ").orElse("") +
