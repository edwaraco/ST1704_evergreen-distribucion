...
class ClienteResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "18!M@NRLv.)r";
    private static final String UPDATED_EMAIL = "j@P;.4#y8#";
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.identificador(UPDATED_IDENTIFICADOR).telefono(UPDATED_TELEFONO).direccion(UPDATED_DIRECCION);
